...
func init() {
	...
	// dameng
	serviceRules["dameng"] = serviceRule{
		Tls: false,
		DataGroup: []ruleData{
			{
				ActionSend,
				[]byte(""),
				nil,
			},
			{
				ActionRecv,
				nil,
				[]*regexp.Regexp{
					regexp.MustCompile(`(?s)\x00\x00\x00\x00\xe4\x00`),
					regexp.MustCompile(`(?s)\x40\x00\x00\x00`),
				},
			},
		},
	}
